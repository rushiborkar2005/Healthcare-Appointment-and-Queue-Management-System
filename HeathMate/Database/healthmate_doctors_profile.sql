...
DROP TABLE IF EXISTS `doctors_profile`;
...
CREATE TABLE `doctors_profile` (
  ...
  CONSTRAINT `doctors_profile_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `user_doctor` (`doctor_id`)
...
LOCK TABLES `doctors_profile` WRITE;
/*!40000 ALTER TABLE `doctors_profile` DISABLE KEYS */;
/*!40000 ALTER TABLE `doctors_profile` ENABLE KEYS */;
UNLOCK TABLES;
